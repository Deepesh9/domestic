...
import SuperadminNavbar from '../navbar/Superadmin-Navbar'; // Corrected import name
...
const styles = {
  mainContent: {
    ...
    minHeight: "100vh",
    paddingTop: "7rem", // Adjust for the header
  },
  container: {
    display: "flex",
        ...
        <div style={styles.container}>
          <div style={styles.infoWrapper}>
            <div style={styles.infoBox}>
              <h2 style={styles.infoHeading}>Device Information</h2>
